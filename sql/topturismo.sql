...
--
-- Host: localhost:3307
-- Tempo de geração: 04/09/2026 às 22:42
...
CREATE TABLE `usuarios` (
  ...
  `chave_recuperacao_hash` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `reservas`
  ...
  ADD KEY `idx_reservas_destino` (`id_destino`),
  ADD KEY `idx_reservas_data` (`id_destino`,`data_viagem`);
