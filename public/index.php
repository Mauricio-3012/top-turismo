...
<?php if ($isAdmin): ?>
                            <li class="nav-item"><a class="nav-link text-white" href="../src/pages/admin/dashboard.php">Gerenciar destinos</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
...
<?php if (isset($_SESSION["usuario_id"])): ?>
                                ...
                                <?php if ($isAdmin): ?><li><a class="dropdown-item" href="../src/pages/admin/dashboard.php"><i class="bi bi-speedometer2 me-2"></i>Painel Admin</a></li><?php endif; ?>
...
<?php if ($isAdmin): ?>
                    ...
                    <div class="text-center mt-3">
                        <a href="../src/pages/admin/adicionar-destino.php" class="btn btn-custom btn-lg rounded-pill px-4">
        ...
        <div aria-labelledby="menuMobileLabel" class="offcanvas offcanvas-end" id="menuMobile" tabindex="-1">
            ...
            <div class="offcanvas-body">
                <ul class="list-unstyled">
                    ...
                    <?php if ($isAdmin): ?>
                    <li class="mb-2">
                        <a class="d-flex align-items-center gap-3 p-2 rounded menu-mobile-item" href="../src/pages/admin/dashboard.php">
...
<?php if (isset($_SESSION["usuario_id"])): ?>
                    ...
                    <?php if ($isAdmin): ?><li class="mb-2"><a href="../src/pages/admin/dashboard.php" class="d-flex align-items-center gap-3 p-2 rounded menu-mobile-item"><i class="bi bi-speedometer2 fs-4"></i> Painel Admin</a></li><?php endif; ?>
