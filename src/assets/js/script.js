...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function abrirDetalhes(botao) {
    ...
    const imagem = card.querySelector(".card-img-top")?.getAttribute("src") || (window.TOP_TURISMO_BASE || "../") + "src/assets/imagens/hero-bg.jpg";
    ...
    if (elMaps) {
      ...
      elMaps.innerHTML = `<img class="google-maps-icon" src="${window.TOP_TURISMO_BASE || "../"}src/assets/imagens/google-maps.svg" alt="Google Maps">`;
    }
